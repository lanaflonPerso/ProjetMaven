...
@WebServlet("/comment")
public class FormCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public FormCommentServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("page", "/WEB-INF/comment/FormComment.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("message= "+ctrl.getMsgContenu());
		System.out.println("error= "+ctrl.isError());
